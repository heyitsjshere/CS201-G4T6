...
def clean_dataset(df, dataset_name):
    ...
    # Step 1: Drop columns with >40% null values
    ...
    # Step 2: Drop rows with null values in columns that have 10-40% null values
    null_percentages = df.isnull().sum() / len(df) * 100
    ...
    # Step 3: Drop rows with null values in columns that have <10% null values
    null_percentages = df.isnull().sum() / len(df) * 100
